...
const Footer_Product = () => {
  return (
    <div className="w-5/6 mx-auto flex justify-between pt-20 pb-5 mt-5 shadow-sm">
      <div className="w-full flex flex-col gap-2">
        <h1 className="font-bold text-lg">HELP & INFORMATION</h1>
      ...
      <div className="w-full flex flex-col gap-2">
        <h1 className="font-bold text-lg">ABOUT ASOS</h1>
      ...
      <div className="w-full flex flex-col gap-2">
        <h1 className="font-bold text-lg">MORE FROM ASOS</h1>
        <Link href={"/help"}>Help</Link>
        <Link href={"/help"}>Track order</Link>
        <Link href={"/help"}>Delivery & return</Link>
        <Link href={"/help"}>Sitemap</Link>
