    ...
    <div className="w-full h-auto mt-10">
      ...
      <div className="w-full h-max border shadow-2xl flex justify-evenly gap-32">
        <div className="relative w-1/2">
          <div className="w-full shadow-sm border-r-2 border-red-500">
            <img
        ...
        <div className="w-1/2 flex flex-col gap-10 py-10 pr-10">
          <div className="w-full text-left font-mono">{state.description}</div>
          ...
          <div className="w-full ">
            ...
            />
            {size == "" && (
              <span className="font-thin text-red-400 text-xs">
